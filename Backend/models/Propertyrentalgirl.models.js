...
const PropertyrentalgirlSchema = new mongoose.Schema({
...
const Propertyrentalgirl = mongoose.model('Propertyrentalgirl', PropertyrentalgirlSchema);
export default Propertyrentalgirl;
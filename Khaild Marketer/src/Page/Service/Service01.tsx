...
const DROPDOWN_FIELDS = [
  { label: "المدينة", options: ["الرياض", "جدة", "الدمام", "الخبر", "مكة"] },
  { label: "الحي", options: ["الملقا", "النرجس", "الياسمين", "العارض"] },
  { label: "نوع الاستخدام", options: ["سكني", "تجاري", "استثماري"] },
  { label: "عدد الغرف", options: ["1", "2", "3", "4", "5+"] },
  {
    label: "المساحة",

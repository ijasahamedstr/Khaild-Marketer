  ...
  return (
    ...
    >
      ...
      <Box sx={{ mt: 5 }}>
        ...
        <TextField multiline minRows={4} fullWidth placeholder="اكتب ملاحظاتك هنا..." value={notes} onChange={(e) => setNotes(e.target.value)}
            sx={{
              "& .MuiInputBase-input": {
                fontSize: "1.8rem",
                color: "black",
      ...
      <Box sx={{ mt: 6, p: 3, borderRadius: 3, border: "1px solid #eef3f3", backgroundColor: "#fafafa" }}>
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 2 }}>
          ...
          <Box sx={{ flexGrow: 1, textAlign: "center", marginLeft: "150px" }}>
            <Typography sx={{ fontFamily: TAJAWAL, fontWeight: 800, fontSize: "20px", direction: "ltr", color: "#1D4ED8", backgroundColor: "#F8FAFC", px: 3, py: 1, borderRadius: "999px", display: "inline-block", boxShadow: "0 6px 20px rgba(37,99,235,0.35)", letterSpacing: "0.5px" }}>
              📞 +966 00 000 0000
            </Typography>
          </Box>
        </Box>

...
const serviceCards: ServiceCard[] = [
  ...
  },
  {
    ...
    href: "/services1/تسليم واستلام العقار",
  },
  {
    id: 7,
    title: " النظام يجيب",
  ...
  },
  {
    ...
    href: "/services1/خدمات التوثيق",
  },
  {
    id: 9,
     title: "خدمات المحاماة",
    description:
      "نقدّم خدمات قانونية شاملة  في مختلف التخصصات. من الاستشارات إلى الترافع، نحرص على حفظ حقوقك بكل احترافية وثقة.",
    href: "/services1/خدمات المحاماة",
  },
   {
    id: 12,
   ...
   description:"نقدّم لك خدمة تقييم عقاري دقيقة ومعتمدة تساعدك في اتخاذ القرار الصحيح.اعرف القيمة الحقيقية لعقارك من أهل الخبرة والاختصاص.",  
    href: "/services1/التقييم العقاري",
  },
  {
    id: 13,
    ...
    href: "/services1/تملّك الأجانب للعقارات ",
  },
    {
    id: 14,
     title: "خدمات التصوير العقاري",
    description:"نوفر تصويرًا احترافيًا للعقار يعكس جماله ويعزز فرص البيع أو التأجير بشكل جذاب ودقيق.",
    href: "/services1/خدمات التصوير العقاري",
  },
  {
    id: 10,
    title: "الوقف العقاري",
    description:
      "يضم نخبة من المختصين للرد على استفساراتكم حول عقارات الوقف بيع وشراء وتأجير العقارات الوقفية وبما يتوافق مع الأنظمة الشرعية والتنظيمية.",
    href: "/services1/الوقف العقاري",
  },
  {
    id: 11,
    ...
    href: "/services1/قسم التمويل العقاري",
  },
